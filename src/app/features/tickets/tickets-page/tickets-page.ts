    ...
    <form [formGroup]="form" class="ttf-form">
      <div class="ttf-field">
        <label class="ttf-label"
          >Template Name <span class="ttf-req">*</span></label
        >
        <input
          z-input
        ...
        <span class="ttf-error"
          ><div z-icon zType="circle-alert" class="ttf-icon-xs"></div>
          Name is required (min 2 characters)</span
        >
        }
      </div>
      ...
      <div class="ttf-field">
        <label class="ttf-label"
          >Description <span class="ttf-req">*</span></label
        >
        <textarea
          z-input
      ...
      <div class="ttf-field">
        ...
        <div class="ttf-tier-grid">
          ...
          >
            <div
              ...
              class="ttf-tier-icon"
              [style.color]="
                form.get('tier')?.value === opt.value ? opt.accent : ''
              "
            ></div>
            <span
              class="ttf-tier-label"
              [style.color]="
                form.get('tier')?.value === opt.value ? opt.accent : ''
              "
            >
        ...
        <div class="ttf-tier-locked">
          <div
            ...
            class="ttf-icon-sm"
            style="color:var(--es-muted)"
          ></div>
          <div>
            <p class="ttf-tier-locked__name">{{ getSelectedTierLabel() }}</p>
            <p style="font-size:.72rem;color:var(--es-muted)">
      ...
      <div class="ttf-field">
        <label class="ttf-label"
          >Default Price (EGP) <span class="ttf-req">*</span></label
        >
        <div class="ttf-price-wrap">
          ...
          <input
            ...
            step="0.01"
            placeholder="0.00"
            class="ttf-input ttf-input--price"
          />
        </div>
        @if (form.get('defaultPrice')?.invalid &&
        form.get('defaultPrice')?.touched) {
        <span class="ttf-error"
          ><div z-icon zType="circle-alert" class="ttf-icon-xs"></div>
...
@Component({
  ...
  styles: [
    `
      ...
      .card-enter {
        animation: fade-up 0.36s cubic-bezier(0.22, 1, 0.36, 1) both;
      }
    ...
    <div class="tp-root">
      <div class="tp-inner page-enter">
        ...
        <div class="tp-grid">
          ...
          <div
            class="tp-card card-enter"
            [style.border-color]="getMeta(tpl.tier).accentBorder"
            [style.animation-delay]="i * 40 + 'ms'"
          >
            <div
              class="tp-card__bar"
              [style.background]="getMeta(tpl.tier).accent"
            ></div>
              ...
              <div class="tp-card__head">
                ...
                <div class="tp-actions">
                  ...
                  <div class="tp-del-confirm">
                    ...
                    <button
                      class="tp-action-btn tp-action-btn--del"
