...
@Component({
  ...
  styles: [
    `
      ...
      :host {
        --coral: #1c4ab0;
        --coral-dim: rgba(28, 74, 176, 0.08);
        --coral-brd: rgba(28, 74, 176, 0.2);
        --coral-hover: #0f2d5f;
        --gold: #f59e0b;
        --gold-dim: rgba(245, 158, 11, 0.08);
        --gold-brd: rgba(245, 158, 11, 0.2);
        --violet: #7c3aed;
        --violet-dim: rgba(124, 58, 237, 0.08);
        --violet-brd: rgba(124, 58, 237, 0.2);
        --green: #10b981;
      ...
      .stat-card {
        background: var(--bg);
        border: 1.5px solid rgba(28, 74, 176, 0.1);
        box-shadow: 0 4px 20px rgba(28, 74, 176, 0.08);
        border-radius: 16px;
        transition: all 0.25s ease;
      }
      .stat-card:hover {
        border-color: rgba(28, 74, 176, 0.2);
        box-shadow: 0 8px 32px rgba(28, 74, 176, 0.12);
      ...
      .stat-num {
        ...
        color: var(--text);
        animation: counter-up 0.55s cubic-bezier(0.22, 1, 0.36, 1) both;
      }
      .stat-label {
        font-family: var(--fm);
        font-size: 0.6rem;
      ...
      .ev-row:hover {
        background: rgba(28, 74, 176, 0.04);
      }
      ...
      .cap-track {
        height: 5px;
        border-radius: 99px;
        background: rgba(28, 74, 176, 0.08);
        overflow: hidden;
        margin-top: 6px;
      }
      .cap-fill {
      ...
      .tag--upcoming {
        ...
        color: var(--coral);
        border: 1px solid var(--coral-brd);
      }
      .tag--past {
      ...
      .act-icon {
        ...
        justify-content: center;
        font-size: 0.85rem;
        border: 1px solid rgba(28, 74, 176, 0.15);
        background: rgba(28, 74, 176, 0.05);
        transition: all 0.2s ease;
      }
      .act-item:hover .act-icon {
        border-color: rgba(28, 74, 176, 0.25);
      ...
      .qa-btn {
        ...
        border-radius: 14px;
        border: 1.5px solid rgba(28, 74, 176, 0.1);
        background: rgba(28, 74, 176, 0.02);
        cursor: pointer;
        transition: all 0.2s ease;
        text-align: left;
        width: 100%;
      ...
      .sparkline-path {
        ...
        animation: line-draw 1.4s cubic-bezier(0.22, 1, 0.36, 1) 0.3s both;
      }
      ...
      .primary-btn {
        ...
        border: none;
        cursor: pointer;
        box-shadow: 0 6px 24px rgba(28, 74, 176, 0.35);
        position: relative;
        overflow: hidden;
      ...
      .primary-btn:hover {
        ...
        box-shadow: 0 10px 36px rgba(28, 74, 176, 0.45);
        transform: translateY(-2px);
      }
  ...
  template: `
    <div
      ...
      style="background:var(--bg);color:var(--text);font-family:var(--fb)"
    >
      <!-- ══════════════════════════════════════════
       EDITORIAL HEADER
  ══════════════════════════════════════════ -->
      ...
      >
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden">
          <div
            class="orb"
            style="width:45vw;height:45vw;top:-22%;left:-10%;
           background:radial-gradient(circle,rgba(255,68,51,.07) 0%,transparent 65%)"
          ></div>
          <div
            class="orb"
            style="width:32vw;height:32vw;top:5%;right:-6%;
           background:radial-gradient(circle,rgba(240,180,41,.05) 0%,transparent 65%)"
          ></div>
        </div>

        <div
          class="relative z-10 max-w-screen-xl mx-auto px-5 sm:px-8 lg:px-12 py-10"
        >
          <div
          ...
          >
            ...
            <div>
              <div class="flex items-center gap-2 mb-4">
                <span
                  style="font-family:var(--fm);font-size:.6rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(255,68,51,.8)"
                >
                  ◆ Overview
                </span>
              </div>
              <h1
                style="font-family:var(--fd);font-size:clamp(3.2rem,8vw,6.8rem);line-height:.88;letter-spacing:.03em;color:var(--text);margin:0"
              >
                YOUR<br />
                <span style="color:transparent;-webkit-text-stroke:2px #FF4433"
                  >DASHBOARD</span
                >
              </h1>
              <p
                class="mt-3"
                style="font-size:.9rem;color:var(--muted);font-weight:300;max-width:400px;line-height:1.7"
              >
                @if (orgName()) {
                {{ orgName() }} &nbsp;·&nbsp; } Everything happening across your
                events, at a glance.
              </p>
            </div>
          ...
          <!-- Tab bar -->
          <div
            class="flex items-center gap-0 mt-8 border-b"
      ...
      <div class="max-w-screen-xl mx-auto px-5 sm:px-8 lg:px-12 py-8">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div
              class="lg:col-span-2 skeleton skeleton-rect"
              style="height:340px"
            ></div>
        ...
        >
          ...
          <div>
            <p
              style="font-family:var(--fd);font-size:1.6rem;letter-spacing:.06em;color:var(--text)"
            >
        ...
        <div class="flex flex-col gap-5">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div
              class="stat-card stat-card--violet page-enter"
            ...
            <div
              class="stat-card stat-card--coral page-enter"
            ...
            >
              ...
              <div
                class="stat-badge"
                style="background:rgba(255,68,51,.1);color:var(--coral);border:1px solid var(--coral-brd)"
              >
            ...
            <div
              class="stat-card stat-card--green page-enter"
            ...
            <div
              class="stat-card stat-card--gold page-enter"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div
              class="panel page-enter lg:col-span-2"
            ...
            >
              <div class="panel-head">
                ...
                <div class="flex items-center gap-2">
                  <span class="tag--live">
                    <span
                      style="width:5px;height:5px;border-radius:50%;background:currentColor;animation:pulse-dot 2s infinite;flex-shrink:0;display:inline-block"
                    ></span>
                    Live Data
                  </span>
                </div>
              ...
              <div class="panel-body">
                ...
                <div style="position:relative">
                  ...
                  >
                    ...
                    <line
                      [attr.x1]="chartPad"
                      [attr.x2]="chartW - chartPad"
                      [attr.y1]="g"
                      [attr.y2]="g"
                      stroke="rgba(242,238,230,.04)"
                      stroke-width="1"
                    />
                    }
                    <!-- Fill area -->
                    ...
                    />
                    <!-- Dots -->
                    @for (pt of monthlyChartPoints(); track $index; let last =
                    $last) {
                    <circle
                      [attr.cx]="pt.x"
                      [attr.cy]="pt.y"
                  ...
                  <div class="flex justify-between mt-2 px-3">
                    ...
                    <span
                      style="font-family:var(--fm);font-size:.52rem;letter-spacing:.08em;text-transform:uppercase;"
                      [style.color]="
                        last ? 'var(--coral)' : 'rgba(242,238,230,.22)'
                      "
                ...
                >
                  <p
                    style="font-family:var(--fm);font-size:.62rem;letter-spacing:.12em;text-transform:uppercase;color:var(--muted)"
                  >
                    Not enough data yet
                  </p>
                </div>
                ...
                <div class="grid grid-cols-3 gap-3 mt-5">
                  ...
                  <div
                    style="padding:.75rem 1rem;border-radius:14px;background:rgba(255,255,255,.022);border:1px solid var(--border)"
                  >
                    <div
                      style="font-family:var(--fd);font-size:1.6rem;letter-spacing:.04em;color:var(--text)"
                    >
                      {{ s.value }}
                    </div>
                    <div
                      style="font-family:var(--fm);font-size:.57rem;letter-spacing:.14em;text-transform:uppercase;color:var(--muted);margin-top:2px"
                    >
                      {{ s.label }}
                    </div>
                  </div>
            ...
            <div class="page-enter" style="animation-delay:310ms">
              ...
              <div class="panel h-full flex flex-col">
                <div class="panel-head">
                  ...
                  <span class="tag tag--upcoming">
                    <span
                      style="width:5px;height:5px;border-radius:50%;background:currentColor;animation:pulse-dot 2.2s infinite;display:inline-block"
                    ></span>
                    Soon
                  </span>
                </div>
                ...
                >
                  ...
                  <img
                    [src]="nextUpcoming()!.event_img_url"
                  ...
                  <div
                    ...
                    [style]="getGradient(nextUpcoming()!)"
                  >
                    <div
                      class="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none select-none"
                    >
                      <span
                        style="font-family:var(--fd);font-size:5rem;letter-spacing:.06em;color:transparent;
                  ...
                  <div
                    ...
                    style="background:linear-gradient(to top,var(--bg2) 0%,transparent 60%)"
                  ></div>
                </div>
                <!-- Info -->
                <div class="flex-1 flex flex-col gap-3 p-5">
                  ...
                  <span
                    style="font-family:var(--fm);font-size:.6rem;letter-spacing:.16em;text-transform:uppercase;color:var(--coral)"
                  >
                    {{ nextUpcoming()!.category?.name }}
                  </span>
                  }
                  <h3
                    style="font-family:var(--fd);font-size:1.6rem;letter-spacing:.03em;color:var(--text);line-height:.94;margin:0"
                  >
                    {{ nextUpcoming()!.title }}
                  </h3>
                  <!-- Date & location tiles -->
                  <div class="flex flex-col gap-2 mt-auto">
                    ...
                    >
                      ...
                      <span
                        style="font-size:.78rem;font-weight:600;color:var(--text)"
                      >
                        {{
                    ...
                    >
                      ...
                      <span
                        style="font-size:.78rem;font-weight:600;color:var(--text)"
                      >
                        @if (nextUpcoming()!.event_location_type ===
                        EventLocationType.Online) { Online Event } @else {
                        {{ nextUpcoming()!.city }}@if (nextUpcoming()!.region)
                        {, {{ nextUpcoming()!.region }}} }
                      </span>
                    </div>
                  </div>
                  <button
                    class="primary-btn w-full justify-center mt-1"
                  ...
                  >
                    ...
                    >
                    <svg
                      style="width:12px;height:12px;position:relative;z-index:1"
                      fill="none"
                      stroke="currentColor"
                      stroke-width="2.5"
                      viewBox="0 0 24 24"
              ...
              <!-- No upcoming -->
              <div
                class="panel h-full flex flex-col items-center justify-center text-center gap-4 p-8"
              >
                <div
                ...
                <div>
                  <p
                    style="font-family:var(--fd);font-size:1.3rem;letter-spacing:.06em;color:var(--text)"
                  >
                    No Upcoming Events
                  </p>
                  <p class="mt-1" style="font-size:.8rem;color:var(--muted)">
                    Create one to get started.
                  </p>
                </div>
                <button class="primary-btn" routerLink="/events">
                  <svg
                    style="width:13px;height:13px;position:relative;z-index:1"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="2.5"
                    viewBox="0 0 24 24"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            >
              <div class="panel-head">
                ...
                <button class="cta-link" routerLink="/events">
                  View All →
                </button>
              </div>
              ...
              <div
                class="flex flex-col items-center justify-center py-14 text-center gap-3"
              >
                <svg
                  class="w-8 h-8"
                  style="color:rgba(242,238,230,.18)"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="1.5"
                  viewBox="0 0 24 24"
                ...
                <p
                  style="font-family:var(--fd);font-size:1.2rem;letter-spacing:.06em;color:var(--text)"
                >
                  No Events Yet
                </p>
              ...
              } @else { @for (event of recentEvents(); track event.id; let i =
              $index) {
              <div
                class="ev-row page-enter"
                [style.animation-delay]="400 + i * 55 + 'ms'"
                routerLink="/events"
              >
                <!-- Thumb -->
                <div
                  class="ev-thumb"
                  [style]="event.event_img_url ? '' : getGradient(event)"
                >
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="panel-body flex flex-col gap-4">
                  ...
                  >
                    <div class="flex items-center justify-between mb-1.5">
                      <span
                        style="font-weight:500;font-size:.83rem;color:var(--text)"
                        >{{ cat.name }}</span
                      >
                      <span
                        style="font-family:var(--fm);font-size:.58rem;letter-spacing:.1em;color:var(--muted)"
                      >
              ...
              <div class="panel page-enter" style="animation-delay:460ms">
                ...
                <div
                  style="padding:.7rem .9rem;display:flex;flex-direction:column;gap:.45rem"
                >
          ...
          <!-- ── FOOTER STRIP ── -->
          <div
            class="page-enter flex items-center justify-between flex-wrap gap-4"
            style="animation-delay:520ms;padding:1.1rem 1.4rem;border-radius:20px;
                    background:var(--bg2);border:1px solid var(--border)"
          >
            <div class="flex items-center gap-3">
              <span
                style="font-family:var(--fd);font-size:1.25rem;letter-spacing:.06em;color:var(--text)"
              >
                {{ orgName()?.toUpperCase() }}
              </span>
              <span
                style="font-family:var(--fm);font-size:.55rem;letter-spacing:.14em;text-transform:uppercase;
            ...
            <div class="flex items-center gap-5 flex-wrap">
              ...
              <div class="text-center">
                <div
                  style="font-family:var(--fd);font-size:1.2rem;letter-spacing:.04em;color:var(--text)"
                >
                  {{ s.value }}
                </div>
                <div
                  style="font-family:var(--fm);font-size:.52rem;letter-spacing:.14em;text-transform:uppercase;color:var(--muted)"
                >
                  {{ s.label }}
                </div>
              </div>
...
export class DashboardHomeComponent implements OnInit {
  ...
  stats = computed(() => {
    ...
    return {
      ...
      online: all.filter(
        (e) => e.event_location_type === EventLocationType.Online
      ).length,
      inperson: all.filter(
        (e) => e.event_location_type !== EventLocationType.Online
      ).length,
  ...
  topCategories = computed<{ name: string; count: number; pct: number }[]>(
    () => {
      ...
      for (const e of this.events()) {
        if (e.category?.name)
          map.set(e.category.name, (map.get(e.category.name) ?? 0) + 1);
      }
  ...
  chartFillPath = computed(() => {
    ...
    const W = this.chartW,
      H = this.chartH,
      P = this.chartPad;
    return `M ${pts[0].x},${pts[0].y} L ${pts
      .map((p) => `${p.x},${p.y}`)
      .join(' L ')} L ${W - P},${H} L ${P},${H} Z`;
  });
