            ...
            <div class="ed-meta-item">
              ...
              <div class="ed-org-row">
                ...
                <button
                  ...
                  [attr.aria-label]="
                    isFollowingOrg()
                      ? 'Unfollow ' + event()!.organization?.name
                      : 'Follow ' + event()!.organization?.name
                  "
                >
                  @if (isFollowingOrg()) {
                  <svg
        ...
        <aside class="ed-ticket-panel">
          ...
          <div class="ed-groups">
            ...
            >
              <div
                z-icon
                [zType]="group.meta.icon"
                class="ed-tier-row__icon"
              ></div>
              <span
                class="ed-tier-row__label"
                [style.color]="group.meta.accent"
              >
                {{ group.meta.label | uppercase }}
              </span>
              <span class="ed-tier-row__count">
                {{ group.tickets.length }} OPTION{{
            ...
            >
              ...
              <div class="ed-tkt__body">
                <div class="ed-tkt__left">
                  <div class="ed-tkt__name">
                    {{ t.ticketTemplate?.name || group.meta.label + ' Ticket' }}
                  </div>
                  @if (t.ticketTemplate?.description) {
                  <div class="ed-tkt__desc">
                    {{ t.ticketTemplate?.description }}
                  </div>
                  }
                ...
                <div class="ed-tkt__price">
                  @if (t.actualPrice === 0) {
                  <span class="ed-price--free" [style.color]="group.meta.accent"
                    >FREE</span
                  >
                  } @else {
                  <span
                    class="ed-price--amt"
                    [style.color]="group.meta.accent"
                    >{{ t.actualPrice | number : '1.0-0' }}</span
                  >
          ...
          <div class="ed-cta">
            ...
            >
              @if (booking()) {
              <span class="ed-spin"></span> Booking… } @else if
              (!selectedTicketId()) { Select a ticket } @else {
              <svg
                width="15"
                height="15"
                fill="none"
            ...
            <div class="ed-success">
              ...
              <div>
                ...
                <div class="ed-success__sub">
                  Check <strong>My Bookings</strong> for your ticket.
                </div>
              </div>
            </div>
            ...
            <div class="ed-follow-prompt">
              ...
              <div class="ed-follow-prompt__body">
                <p class="ed-follow-prompt__text">
                  Follow <strong>{{ event()!.organization!.name }}</strong> to
                  see their future events
                </p>
              </div>
  ...
  styles: [
    `
      ...
      .ed-tkt {
        ...
        cursor: pointer;
        overflow: hidden;
        transition: border-color 0.2s, background 0.2s, box-shadow 0.22s;
      ...
      .ed-tkt--selected {
        ...
        background: var(--a-dim, rgba(240, 180, 41, 0.06)) !important;
        box-shadow: 0 0 20px
          color-mix(in srgb, var(--a, #f0b429) 28%, transparent);
      }
      .ed-tkt--sold-out {
        opacity: 0.38;
        cursor: not-allowed;
      ...
      .ed-badge--sold {
        ...
        color: var(--coral);
        border-color: rgba(255, 68, 51, 0.22);
      }
      .ed-tkt__price {
        display: flex;
        flex-direction: column;
      ...
      .ed-follow-prompt {
        ...
        animation: slideIn 0.35s 0.15s both;
      }
      ...
      .subscribe({
        next: () => {
          ...
          this.tickets.update((l) =>
            l.map((t) =>
              t.id === id ? { ...t, soldQuantity: t.soldQuantity + 1 } : t
            )
          );
        },
        error: (err: any) => {
