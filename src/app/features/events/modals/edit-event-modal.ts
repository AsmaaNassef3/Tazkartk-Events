...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="modal-enter relative w-full sm:max-w-[660px] max-h-[96dvh] sm:max-h-[90vh]
            flex flex-col overflow-hidden rounded-t-3xl sm:rounded-3xl
            border-1.5 border-[#E2E8F0] shadow-[0_8px_32px_rgba(37,99,235,.12)]"
        style="background:#ffffff;color:var(--text-900);font-family:'Plus Jakarta Sans',sans-serif"
        (click)="$event.stopPropagation()"
      >
        <!-- Header -->
        <div
          class="shrink-0 flex items-center justify-between px-6 py-5 border-b"
          style="border-color:var(--border)"
        >
          <div class="flex items-center gap-3">
            <div
              class="w-9 h-9 rounded-xl flex items-center justify-center shrink-0"
              style="background:linear-gradient(135deg,var(--primary),#60a5fa)"
            >
              <svg
            ...
            <div>
              <p
                style="font-family:'Bebas Neue',sans-serif;font-size:1.15rem;letter-spacing:.05em;color:var(--text-900);line-height:1"
              >
                EDIT EVENT
              </p>
              <p
                class="text-[11px] truncate max-w-[260px]"
                style="color:var(--text-400);font-family:'DM Mono',monospace;letter-spacing:.06em"
              >
                {{ event().title }}
              </p>
            </div>
          ...
          <button
            ...
            style="background:rgba(37,99,235,.06);border:1px solid rgba(37,99,235,.12);color:var(--text-400)"
          >
            <svg
              class="w-4 h-4"
              fill="none"
        ...
        <div class="flex-1 flex items-center justify-center py-16">
          <div
            class="spin w-7 h-7 rounded-full"
            style="border:2px solid rgba(37,99,235,.15);border-top-color:var(--primary)"
          ></div>
        </div>
        } @else if (eventForm) {
        <form
        ...
        >
          <div class="flex-1 overflow-y-auto thin-scroll px-6 py-6 space-y-7">
            ...
            <div class="space-y-2">
              <label
                style="font-family:'DM Mono',monospace;font-size:.62rem;letter-spacing:.16em;text-transform:uppercase;color:var(--text-400)"
                >Event Title *</label
              >
              ...
              <p class="text-[11px]" style="color:#FF4433">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    <p
                      style="font-family:'DM Mono',monospace;font-size:.57rem;letter-spacing:.16em;text-transform:uppercase;color:var(--text-400)"
                    >
                      Starts
                    </p>
            ...
            <div class="space-y-3">
              <div class="flex items-center gap-3">
                ...
                @if (isOnline()) {
                <span
                  class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-semibold"
              ...
              <div
                ...
                style="background:rgba(37,99,235,.04);border:1px solid var(--border)"
              >
                <div class="grid grid-cols-2 gap-4">
                  <div class="space-y-1.5">
                    <p
                      style="font-family:'DM Mono',monospace;font-size:.58rem;letter-spacing:.14em;text-transform:uppercase;color:var(--text-400)"
                    >
                      City *
                    </p>
              ...
              <div
                class="flex items-start gap-4 p-4 rounded-2xl"
                style="background:rgba(240,180,41,.05);border:1px solid rgba(240,180,41,.2)"
              >
                <div
                  class="w-8 h-8 rounded-xl flex items-center justify-center shrink-0"
            ...
            <div class="space-y-2">
              ...
              <div
                class="mt-2 rounded-xl overflow-hidden h-28 border"
                style="border-color:var(--border)"
              >
                <img
                  [src]="eventForm.get('event_img_url')?.value"
          ...
          <!-- Footer -->
          <div
            class="shrink-0 flex items-center justify-between gap-3 px-6 py-4 border-t"
          ...
          >
            <button
              ...
              style="color:var(--text-400);border:1px solid var(--border);background:rgba(37,99,235,.04)"
            >
              Cancel
            </button>
            <button
              ...
              style="background:linear-gradient(135deg,var(--primary),#60a5fa);box-shadow:0 0 30px rgba(37,99,235,.25)"
            >
              @if (submitting()) {
              <div
                class="spin w-4 h-4 rounded-full"
                style="border:2px solid rgba(255,255,255,.3);border-top-color:#fff"
              ></div>
              Saving... } @else {
              <svg
                class="w-4 h-4"
...
export class EditEventModalComponent implements OnInit {
  ...
  private initForm() {
    const e = this.event();
    const isOnline =
      (e.event_location_type ?? EventLocationType.Offline) ===
  ...
  onSubmit() {
    ...
    this.eventService.updateEvent(this.event().id, dto).subscribe({
      next: () => {
        ...
        const selectedCat =
          this.categories().find((c) => c.id === newCatId) ?? null;
