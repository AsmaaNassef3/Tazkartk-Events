    ...
    <div class="mm-root">
      ...
      <header class="mm-hero">
        ...
        <div class="mm-hero__body">
          <div class="mm-eyebrow">
            ...
            <span class="mm-tag mm-tag--dim"
              >{{ meetups().length }} joined</span
            >
            }
          </div>
      ...
      <div class="mm-empty">
        ...
        <p class="mm-empty__sub">
          Browse and join a community meetup to get started.
        </p>
        <button
          class="mm-btn"
          (click)="router.navigate(['/user-dashboard/meetups'])"
        >
          Browse Meetups
        </button>
      </div>
      ...
      <div class="mm-list">
        ...
        <div
          class="mm-card"
          [class.mm-card--past]="!isUpcoming(m.start_Time)"
        ...
        >
          ...
          <div class="mm-card__body">
            <div class="mm-card__left">
              ...
              <div class="mm-badges">
                @if (m.category?.name) {
                <span class="mm-badge mm-badge--cat">{{
                  m.category!.name
                }}</span>
                }
                <span
                  class="mm-badge"
                  [class.mm-badge--online]="m.meetup_location_type === 1"
                >
              ...
              <div class="mm-card__meta-list">
                ...
                <div class="mm-card__meta">
                  ...
                  {{ fmtDate(m.start_Time) }} · {{ fmtTime(m.start_Time) }} @if
