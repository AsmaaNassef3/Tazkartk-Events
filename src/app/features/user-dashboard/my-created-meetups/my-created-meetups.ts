  ...
  template: `
    ...
    <div class="mc-root">
      ...
      <header class="mc-hero">
        ...
        <div class="mc-hero__body">
          <div class="mc-eyebrow">
            ...
            <span class="mc-tag mc-tag--dim"
              >{{ meetups().length }} created</span
            >
            }
          </div>
      ...
      <div class="mc-tabs-wrap">
        ...
        <button
          class="mc-tab"
          [class.mc-tab--on]="activeTab() === tab.value"
          ...
          <div class="mc-card__body">
            <div class="mc-card__left">
              <div class="mc-badges">
                ...
                <span
                  class="mc-badge"
                  [class.mc-badge--online]="m.meetup_location_type === 1"
                >
            ...
            <div class="mc-card__right">
              ...
              <div class="mc-bar-wrap">
                <div
                  ...
                  [class.mc-bar-fill--full]="m.isFull"
                ></div>
              </div>
              } @if (m.isFull) {
    ...
    <div class="mc-overlay" (click)="cancelDelete()">
      <div class="mc-modal" (click)="$event.stopPropagation()">
        ...
        <div class="mc-modal__footer">
          ...
          <button
            class="mc-modal-btn mc-modal-btn--confirm"
